...
test_that("Length of y equals length of prov",{
  expect_length(produce_sim_data(1, 10, 10)$y, length(produce_sim_data(1, 10, 10)$prov))
})
...
test_that("Nrows in gt matrix = length y",{
  expect_length(produce_sim_data(1, 10, 10)$y, ncol(produce_sim_data(1, 10, 10)$maa))
  expect_length(produce_sim_data(1, 10, 10)$y, ncol(produce_sim_data(1, 10, 10)$mia))
})
